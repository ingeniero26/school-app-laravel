                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required class="form-control"
                                                value="{{ old('name', $getParent->name) }}" placeholder="nombre"
                                                name="name">
                                            <div style="color:red;">
                                                {{ $errors->first('name') }}
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required class="form-control"
                                                value="{{ old('last_name', $getParent->last_name) }}" placeholder="Apellido"
                                                name="last_name">
                                            <div style="color:red;">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="document_type" id="" required class="form-control">
                                                ...
                                                <option
                                                    {{ old('document_type', $getParent->document_type) == 'CEDULA' ? 'selected' : '' }}
                                                    value="CEDULA">CEDULA</option>
                                                <option
                                                    {{ old('document_type', $getParent->document_type) == 'TI' ? 'selected' : '' }}
                                                    value="TI">TI</option>
                                                <option
                                                    {{ old('document_type', $getParent->document_type) == 'REGISTRO_CIVIL' ? 'selected' : '' }}
                                                    value="REGISTRO_CIVIL">REGISTRO CIVIL</option>
                                                <option
                                                    {{ old('document_type', $getParent->document_type) == 'PASAPORTE' ? 'selected' : '' }}
                                                    value="PASAPORTE">PASAPORTE</option>
                                                <option
                                                    {{ old('document_type', $getParent->document_type) == 'OTRO' ? 'selected' : '' }}
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('address', $getParent->address) }}" placeholder=""
                                                name="address">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('mobile_number', $getParent->mobile_number) }}" placeholder=""
                                                name="mobile_number">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label> Ocupacion<span style="color: red"></span> </label>
                                            <input type="text" class="form-control"
                                                value="{{ old('occupation', $getParent->occupation) }}" placeholder=""
                                                name="occupation">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="{{ old('email', $getParent->email) }}" placeholder="Enter email">
                                        <div style="color:red;">
                                            {{ $errors->first('email') }}
                                        </div>
