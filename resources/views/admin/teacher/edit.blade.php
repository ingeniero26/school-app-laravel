                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            value="{{ old('name',$getTeacher->name) }}"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required class="form-control"
                            value="{{ old('last_name',$getTeacher->last_name) }}"
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <select name="document_type" id="" required class="form-control">
                                ...
                                <option {{ (old('document_type',$getTeacher->document_type)=='CEDULA')?'selected' : '' }} value="CEDULA">CEDULA</option>
                                <option {{ (old('document_type',$getTeacher->document_type)=='TI')?'selected' : '' }}  value="TI">TI</option>
                                <option {{ (old('document_type',$getTeacher->document_type)=='PASAPORTE')?'selected' : '' }}  value="PASAPORTE">PASAPORTE</option>
                                <option {{ (old('document_type',$getTeacher->document_type)=='OTRO')?'selected' : '' }} value="OTRO">Otro</option>
                            </select>
                            <div style="color:red;">
                                {{ $errors->first('gender') }}
                               </div>
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <select name="gender" id="" required class="form-control">
                                ...
                                <option {{ (old('gender',$getTeacher->gender)=='Male')?'selected' : '' }} value="Male">Masculino</option>
                                <option {{ (old('gender',$getTeacher->gender)=='Female')?'selected' : '' }}  value="Female">Femenino</option>
                                <option {{ (old('gender',$getTeacher->gender)=='Other')?'selected' : '' }} value="Other">Otro</option>
                            </select>
                            <div style="color:red;">
                                {{ $errors->first('gender') }}
                               </div>
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <input type="text"  class="form-control"
                            value="{{ old('occupation',$getTeacher->occupation) }}"
                         ...
                         <div class="form-group col-md-6">
                            ...
                            value=""
                            placeholder="Direccin de casa" name="address">{{old('address',$getTeacher->address) }}</textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Direcciòn 2<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"

                            placeholder="Direccin de trabajo" name="permanent_address">{{ old('permanent_address',$getTeacher->permanent_address) }}</textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Calificación<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value=""
                            placeholder="" name="qualification">{{ $getTeacher->qualification }}</textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Experiencia<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value=""
                            placeholder="" name="work_experiencie">{{$getTeacher->work_experiencie }}</textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Notas<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value=""
                            placeholder="" name="notes">{{$getTeacher->notes }}</textarea>
                         </div>
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <input type="text"  class="form-control"
                            value="{{ old('blood_group',$getTeacher->blood_group) }}"
                            placeholder="" name="blood_group">
                         </div>
                         <div class="form-group col-md-6">
                            <label> EPS<span style="color: red"></span> </label>
                            <input type="text"  class="form-control"
                            value="{{ old('eps',$getTeacher->eps) }}"
                            placeholder="" name="eps">
                         </div>
                         <div class="form-group col-md-6">
                            <label>Estado</label>
                            <select name="status" id="" class="form-control">
                                <option {{ ($getTeacher->status == 0)? 'selected' : ''}} value="0">Activo</option>
                                <option {{ ($getTeacher->status == 1)? 'selected' : '' }} value="1">Inactivo</option>
                            </select>
                  ...
                  <div class="form-group">
                    ...
                    <input type="email"
                     name="email"
                    class="form-control"
                    value="{{ old('email',$getTeacher->email) }}"
