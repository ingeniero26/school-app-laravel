                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6">
                            ...
                            value="{{ old('address') }}"
                            placeholder="Direccin de casa" name="address"></textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Direcciòn 2<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value="{{ old('permanent_address') }}"
                            placeholder="Direccin de trabajo" name="permanent_address"></textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Calificación<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value="{{ old('qualification') }}"
                            placeholder="" name="qualification"></textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Experiencia<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value="{{ old('work_experiencie') }}"
                            placeholder="" name="work_experiencie"></textarea>
                         </div>
                         <div class="form-group col-md-6">
                            <label> Notas<span style="color: red"></span> </label>
                            <textarea type="text"  class="form-control"
                            value="{{ old('notes') }}"
                            placeholder="" name="notes"></textarea>
                         </div>
